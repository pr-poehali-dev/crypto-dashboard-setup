...
const CryptoList = () => {
  ...
  if (isLoading) {
    return <div className="glass-card rounded-lg p-6 animate-pulse">Загрузка...</div>;
  }

  return (
    <div className="glass-card rounded-lg p-6 animate-fade-in">
      <h2 className="text-xl font-semibold mb-6">Топ криптовалют</h2>
        ...
        <table className="w-full">
          <thead>
            <tr className="text-left text-sm text-muted-foreground">
              ...
              <th className="pb-4">Изменение за 24ч</th>
